 ...
 */
@Stateless
public class Trim3rangdeselevesparmatiereFacade extends AbstractFacade<Trim3rangdeselevesparmatiere> implements Trim3rangdeselevesparmatiereFacadeLocal {
    ...
    public Trim3rangdeselevesparmatiereFacade() {
        super(Trim3rangdeselevesparmatiere.class);
    }

    @Override
    public List<String> trim3_matiere(String codeclasse) {
    ...
    @Override
    public List<Object[]> trim3_rang_eleve_par_matiere(String codeclasse, String codematiere) {
...
//eleve par matiere avec note  null
    ...
    @Override
    public List<Object[]> trim3_rang_eleve_par_matiere_avec_note_nulle(String codeclasse, String codematiere) {
    ...
    public boolean existe_classe_et_eleve_et_matiere(String codematiere, String matricule, String codeclasse) {
        try {
            Trim3rangdeselevesparmatiere c = em.createNamedQuery("Trim3rangdeselevesparmatiere.rang_eleve_par_matiere", Trim3rangdeselevesparmatiere.class).setParameter("codematiere", codematiere).setParameter("matriculeeleve", matricule).setParameter("codeclasse", codeclasse).getSingleResult();
            if (c != null) {
                return true;
            }
            return false;
