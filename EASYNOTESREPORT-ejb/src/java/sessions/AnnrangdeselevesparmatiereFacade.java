 ...
 */
@Stateless
public class AnnrangdeselevesparmatiereFacade extends AbstractFacade<Annrangdeselevesparmatiere> implements AnnrangdeselevesparmatiereFacadeLocal {
    ...
    public AnnrangdeselevesparmatiereFacade() {
        super(Annrangdeselevesparmatiere.class);
    }

   
    @Override
    public List<String> ann_matiere(String codeclasse) {
    ...
    @Override
    public List<Object[]> ann_rang_eleve_par_matiere(String codeclasse, String codematiere) {
...
//eleve par matiere avec note  null
    ...
    @Override
    public List<Object[]> ann_rang_eleve_par_matiere_avec_note_nulle(String codeclasse, String codematiere) {
    ...
    public boolean existe_classe_et_eleve_et_matiere(String codematiere, String matricule, String codeclasse) {
        try {
            Annrangdeselevesparmatiere c = em.createNamedQuery("Annrangdeselevesparmatiere.rang_eleve_par_matiere", Annrangdeselevesparmatiere.class).setParameter("codematiere", codematiere).setParameter("matriculeeleve", matricule).setParameter("codeclasse", codeclasse).getSingleResult();
            if (c != null) {
                return true;
            }
            return false;
