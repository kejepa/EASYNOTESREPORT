 ...
 */
@Stateless
public class Seq5moyennesrangsdeselevesFacade extends AbstractFacade<Seq5moyennesrangsdeseleves> implements Seq5moyennesrangsdeselevesFacadeLocal {
    ...
    public Seq5moyennesrangsdeselevesFacade() {
        super(Seq5moyennesrangsdeseleves.class);
    }
    ...
    public List<Object[]> findMatriculePourCalculMoyenneParGroupe(String matricule, int groupe) {
        try {
            ...
            String sql = "select cl.coefficient,(n.lanote*cl.coefficient) as notecoef \n"
                    ...
                    + "inner join notesdeselevesseq5 n on l.matriculeeleve = n.matriculeeleve \n"
    ...
    @Override
    public List<Seq5moyennesrangsdeseleves> verifier_si_existe(String matricule) {
        Query query;
        query = em.createNamedQuery("Seq5moyennesrangsdeseleves.findMatriculeeleve");
        query.setParameter("matriculeeleve", matricule);
        List<Seq5moyennesrangsdeseleves> eleves_de_la_classe = query.getResultList();
        if (eleves_de_la_classe == null) {
            return null;
        } else {
            return eleves_de_la_classe;
    ...
    public List<Object[]> ordreDeMeriteDesEleves(String codeclasse) {
        ...
        query = em.createNativeQuery("select s1.matriculeeleve,s1.moyenne,s1.moyg1,s1.moyg2,s1.moyg3,COUNT(s2.moyenne) rang\n"
                ...
                + "      from seq5moyennesrangsdeseleves s \n"
    ...
    @Override
    public List<Object[]> smsMoyRangS5(String codeclasse) {
        Query query;
    ...
    @Override
    public List<Object[]> smsMoyRangS5un(String codeclasse, String matricule) {
        Query query;
        query = em.createNativeQuery("select concat(l.nom,' ',l.prenom)as nomeleve,l.adresse,s.moyenne,s.rang \n"
                + "from listedeseleves l\n"
                + "inner join seq5moyennesrangsdeseleves s on s.matriculeeleve=l.matriculeeleve\n"
    ...
    @Override
    public List<Object[]> smsMoyRangS5serie(String codeclasse, String matriculeDebut, String matriculeFin) {
        Query query;
        query = em.createNativeQuery("select concat(l.nom,' ',l.prenom)as nomeleve,l.adresse,s.moyenne,s.rang \n"
                + "from listedeseleves l\n"
                + "inner join seq5moyennesrangsdeseleves s on s.matriculeeleve=l.matriculeeleve\n"
    ...
    @Override
    public List<Object[]> statparniveaus5(String section) {
        Query query;
