 ...
 */
@Stateless
public class Seq5rangdeselevesparmatiereFacade extends AbstractFacade<Seq5rangdeselevesparmatiere> implements Seq5rangdeselevesparmatiereFacadeLocal {
    ...
    public Seq5rangdeselevesparmatiereFacade() {
        super(Seq5rangdeselevesparmatiere.class);
    }

    @Override
    public List<String> seq5_matiere(String codeclasse) {
    ...
    @Override
    public List<Object[]> seq5_rang_eleve_par_matiere(String codeclasse, String codematiere) {
...
//eleve par matiere avec note  null
    ...
    @Override
    public List<Object[]> seq5_rang_eleve_par_matiere_avec_note_nulle(String codeclasse, String codematiere) {
    ...
    public boolean existe_classe_et_eleve_et_matiere(String codematiere, String matricule, String codeclasse) {
        try {
            Seq5rangdeselevesparmatiere c = em.createNamedQuery("Seq5rangdeselevesparmatiere.rang_eleve_par_matiere", Seq5rangdeselevesparmatiere.class).setParameter("codematiere", codematiere).setParameter("matriculeeleve", matricule).setParameter("codeclasse", codeclasse).getSingleResult();
            if (c != null) {
                return true;
            }
            return false;
