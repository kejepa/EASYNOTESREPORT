 ...
 */
@Stateless
public class Trim2moyennesrangsdeselevesFacade extends AbstractFacade<Trim2moyennesrangsdeseleves> implements Trim2moyennesrangsdeselevesFacadeLocal {
    ...
    public Trim2moyennesrangsdeselevesFacade() {
        super(Trim2moyennesrangsdeseleves.class);
    }
    ...
    public List<Object[]> findMatriculePourCalculMoyenneParGroupe(String matricule, int groupe) {
        try {
            ...
            String sql = "select cl.coefficient,(n.lanote*cl.coefficient) as notecoef \n"
                    ...
                    + "inner join notesdeselevestrim2 n on l.matriculeeleve = n.matriculeeleve \n"
    ...
    @Override
    public List<Trim2moyennesrangsdeseleves> verifier_si_existe(String matricule) {
        Query query;
        query = em.createNamedQuery("Trim2moyennesrangsdeseleves.findMatriculeeleve");
        query.setParameter("matriculeeleve", matricule);
        List<Trim2moyennesrangsdeseleves> eleves_de_la_classe = query.getResultList();
        if (eleves_de_la_classe == null) {
            return null;
        } else {
            return eleves_de_la_classe;
    ...
    public List<Object[]> ordreDeMeriteDesEleves(String codeclasse) {
        ...
        query = em.createNativeQuery("select s1.matriculeeleve,s1.moyenne,s1.moyg1,s1.moyg2,s1.moyg3,COUNT(s2.moyenne) rang\n"
                ...
                + "      from trim2moyennesrangsdeseleves s \n"
    ...
    @Override
    public List<Object[]> smsMoyRangt2(String codeclasse) {
        Query query;
    ...
    @Override
    public List<Object[]> smsMoyRangtun2(String codeclasse, String matricule) {
        Query query;
        query = em.createNativeQuery("select concat(l.nom,' ',l.prenom)as nomeleve,l.adresse,s.moyenne,s.rang \n"
                + "from listedeseleves l\n"
                + "inner join trim2moyennesrangsdeseleves s on s.matriculeeleve=l.matriculeeleve\n"
    ...
    @Override
    public List<Object[]> smsMoyRangtserie2(String codeclasse, String matriculeDebut, String matriculeFin) {
        Query query;
        query = em.createNativeQuery("select concat(l.nom,' ',l.prenom)as nomeleve,l.adresse,s.moyenne,s.rang \n"
                + "from listedeseleves l\n"
                + "inner join trim2moyennesrangsdeseleves s on s.matriculeeleve=l.matriculeeleve\n"
    ...
    @Override
    public List<Object[]> statparniveaut2(String section) {
        Query query;
