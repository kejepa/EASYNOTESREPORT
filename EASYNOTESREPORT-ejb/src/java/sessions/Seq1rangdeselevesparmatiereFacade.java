 ...
 */
@Stateless
public class Seq1rangdeselevesparmatiereFacade extends AbstractFacade<Seq1rangdeselevesparmatiere> implements Seq1rangdeselevesparmatiereFacadeLocal {
    ...
    public Seq1rangdeselevesparmatiereFacade() {
        super(Seq1rangdeselevesparmatiere.class);
    }

    @Override
    public List<String> seq1_matiere(String codeclasse) {
...
//eleve par matiere avec note non null

    @Override
    public List<Object[]> seq1_rang_eleve_par_matiere(String codeclasse, String codematiere) {
...
//eleve par matiere avec note  null
    ...
    @Override
    public List<Object[]> seq1_rang_eleve_par_matiere_avec_note_nulle(String codeclasse, String codematiere) {
    ...
    public boolean existe_classe_et_eleve_et_matiere(String codematiere, String matricule, String codeclasse) {
        try {
            Seq1rangdeselevesparmatiere c = em.createNamedQuery("Seq1rangdeselevesparmatiere.rang_eleve_par_matiere", Seq1rangdeselevesparmatiere.class).setParameter("codematiere", codematiere).setParameter("matriculeeleve", matricule).setParameter("codeclasse", codeclasse).getSingleResult();
            if (c != null) {
                return true;
            }
            return false;
