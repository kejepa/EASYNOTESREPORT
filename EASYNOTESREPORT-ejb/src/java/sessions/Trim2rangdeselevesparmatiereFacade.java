 ...
 */
@Stateless
public class Trim2rangdeselevesparmatiereFacade extends AbstractFacade<Trim2rangdeselevesparmatiere> implements Trim2rangdeselevesparmatiereFacadeLocal {
    ...
    public Trim2rangdeselevesparmatiereFacade() {
        super(Trim2rangdeselevesparmatiere.class);
    }

    @Override
    public List<String> trim2_matiere(String codeclasse) {
    ...
    @Override
    public List<Object[]> trim2_rang_eleve_par_matiere(String codeclasse, String codematiere) {
...
//eleve par matiere avec note  null
    ...
    @Override
    public List<Object[]> trim2_rang_eleve_par_matiere_avec_note_nulle(String codeclasse, String codematiere) {
    ...
    public boolean existe_classe_et_eleve_et_matiere(String codematiere, String matricule, String codeclasse) {
        try {
            Trim2rangdeselevesparmatiere c = em.createNamedQuery("Trim2rangdeselevesparmatiere.rang_eleve_par_matiere", Trim2rangdeselevesparmatiere.class).setParameter("codematiere", codematiere).setParameter("matriculeeleve", matricule).setParameter("codeclasse", codeclasse).getSingleResult();
            if (c != null) {
                return true;
            }
            return false;
