 ...
 */
@Stateless
public class Seq4rangdeselevesparmatiereFacade extends AbstractFacade<Seq4rangdeselevesparmatiere> implements Seq4rangdeselevesparmatiereFacadeLocal {
    ...
    public Seq4rangdeselevesparmatiereFacade() {
        super(Seq4rangdeselevesparmatiere.class);
    }

    @Override
    public List<String> seq4_matiere(String codeclasse) {
    ...
    @Override
    public List<Object[]> seq4_rang_eleve_par_matiere(String codeclasse, String codematiere) {
...
//eleve par matiere avec note  null
    ...
    @Override
    public List<Object[]> seq4_rang_eleve_par_matiere_avec_note_nulle(String codeclasse, String codematiere) {
    ...
    public boolean existe_classe_et_eleve_et_matiere(String codematiere, String matricule, String codeclasse) {
        try {
            Seq4rangdeselevesparmatiere c = em.createNamedQuery("Seq4rangdeselevesparmatiere.rang_eleve_par_matiere", Seq4rangdeselevesparmatiere.class).setParameter("codematiere", codematiere).setParameter("matriculeeleve", matricule).setParameter("codeclasse", codeclasse).getSingleResult();
            if (c != null) {
                return true;
            }
            return false;
