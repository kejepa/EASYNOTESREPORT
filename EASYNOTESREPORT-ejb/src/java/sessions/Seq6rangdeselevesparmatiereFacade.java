 ...
 */
@Stateless
public class Seq6rangdeselevesparmatiereFacade extends AbstractFacade<Seq6rangdeselevesparmatiere> implements Seq6rangdeselevesparmatiereFacadeLocal {
    ...
    public Seq6rangdeselevesparmatiereFacade() {
        super(Seq6rangdeselevesparmatiere.class);
    }

    @Override
    public List<String> seq6_matiere(String codeclasse) {
    ...
    @Override
    public List<Object[]> seq6_rang_eleve_par_matiere(String codeclasse, String codematiere) {
...
//eleve par matiere avec note  null
    ...
    @Override
    public List<Object[]> seq6_rang_eleve_par_matiere_avec_note_nulle(String codeclasse, String codematiere) {
    ...
    public boolean existe_classe_et_eleve_et_matiere(String codematiere, String matricule, String codeclasse) {
        try {
            Seq6rangdeselevesparmatiere c = em.createNamedQuery("Seq6rangdeselevesparmatiere.rang_eleve_par_matiere", Seq6rangdeselevesparmatiere.class).setParameter("codematiere", codematiere).setParameter("matriculeeleve", matricule).setParameter("codeclasse", codeclasse).getSingleResult();
            if (c != null) {
                return true;
            }
            return false;
