 ...
 */
@Stateless
public class Seq3moyennesrangsdeselevesFacade extends AbstractFacade<Seq3moyennesrangsdeseleves> implements Seq3moyennesrangsdeselevesFacadeLocal {
    ...
    public Seq3moyennesrangsdeselevesFacade() {
        super(Seq3moyennesrangsdeseleves.class);
    }
    ...
    public List<Object[]> findMatriculePourCalculMoyenneParGroupe(String matricule, int groupe) {
        try {
            ...
            String sql = "select cl.coefficient,(n.lanote*cl.coefficient) as notecoef \n"
                    ...
                    + "inner join notesdeselevesseq3 n on l.matriculeeleve = n.matriculeeleve \n"
    ...
    @Override
    public List<Seq3moyennesrangsdeseleves> verifier_si_existe(String matricule) {
        Query query;
        query = em.createNamedQuery("Seq3moyennesrangsdeseleves.findMatriculeeleve");
        query.setParameter("matriculeeleve", matricule);
        List<Seq3moyennesrangsdeseleves> eleves_de_la_classe = query.getResultList();
        if (eleves_de_la_classe == null) {
            return null;
        } else {
            return eleves_de_la_classe;
    ...
    public List<Object[]> ordreDeMeriteDesEleves(String codeclasse) {
        ...
        query = em.createNativeQuery("select s1.matriculeeleve,s1.moyenne,s1.moyg1,s1.moyg2,s1.moyg3,COUNT(s2.moyenne) rang\n"
                ...
                + "      from seq3moyennesrangsdeseleves s \n"
    ...
    @Override
    public List<Object[]> smsMoyRangS3(String codeclasse) {
        Query query;
    ...
    @Override
    public List<Object[]> smsMoyRangS3un(String codeclasse, String matricule) {
        Query query;
        query = em.createNativeQuery("select concat(l.nom,' ',l.prenom)as nomeleve,l.adresse,s.moyenne,s.rang \n"
                + "from listedeseleves l\n"
                + "inner join seq3moyennesrangsdeseleves s on s.matriculeeleve=l.matriculeeleve\n"
    ...
    @Override
    public List<Object[]> smsMoyRangS3serie(String codeclasse, String matriculeDebut, String matriculeFin) {
        Query query;
        query = em.createNativeQuery("select concat(l.nom,' ',l.prenom)as nomeleve,l.adresse,s.moyenne,s.rang \n"
                + "from listedeseleves l\n"
                + "inner join seq3moyennesrangsdeseleves s on s.matriculeeleve=l.matriculeeleve\n"
    ...
    @Override
    public List<Object[]> statparniveaus3(String section) {
        Query query;
