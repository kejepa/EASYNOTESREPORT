 ...
 */
@Stateless
public class Trim1moyennesrangsdeselevesFacade extends AbstractFacade<Trim1moyennesrangsdeseleves> implements Trim1moyennesrangsdeselevesFacadeLocal {
    ...
    public Trim1moyennesrangsdeselevesFacade() {
        super(Trim1moyennesrangsdeseleves.class);
    }
    ...
    @Override
    public List<Trim1moyennesrangsdeseleves> verifier_si_existe(String matricule) {
        Query query;
        query = em.createNamedQuery("Trim1moyennesrangsdeseleves.findMatriculeeleve");
        query.setParameter("matriculeeleve", matricule);
        List<Trim1moyennesrangsdeseleves> eleves_de_la_classe = query.getResultList();
        if (eleves_de_la_classe == null) {
            return null;
        } else {
            return eleves_de_la_classe;
    ...
    @Override
    public List<Object[]> smsMoyRangt1(String codeclasse) {
        Query query;
    ...
    @Override
    public List<Object[]> smsMoyRangtun1(String codeclasse, String matricule) {
        Query query;
        query = em.createNativeQuery("select concat(l.nom,' ',l.prenom)as nomeleve,l.adresse,s.moyenne,s.rang \n"
                + "from listedeseleves l\n"
                + "inner join trim1moyennesrangsdeseleves s on s.matriculeeleve=l.matriculeeleve\n"
    ...
    @Override
    public List<Object[]> smsMoyRangtserie1(String codeclasse, String matriculeDebut, String matriculeFin) {
        Query query;
        query = em.createNativeQuery("select concat(l.nom,' ',l.prenom)as nomeleve,l.adresse,s.moyenne,s.rang \n"
                + "from listedeseleves l\n"
                + "inner join trim1moyennesrangsdeseleves s on s.matriculeeleve=l.matriculeeleve\n"
    ...
    @Override
    public List<Object[]> statparniveaut1(String section) {
        Query query;
