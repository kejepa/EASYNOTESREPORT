 ...
 */
@Stateless
public class Seq3rangdeselevesparmatiereFacade extends AbstractFacade<Seq3rangdeselevesparmatiere> implements Seq3rangdeselevesparmatiereFacadeLocal {
    ...
    public Seq3rangdeselevesparmatiereFacade() {
        super(Seq3rangdeselevesparmatiere.class);
    }

    @Override
    public List<String> seq3_matiere(String codeclasse) {
    ...
    @Override
    public List<Object[]> seq3_rang_eleve_par_matiere(String codeclasse, String codematiere) {
...
//eleve par matiere avec note  null
    ...
    @Override
    public List<Object[]> seq3_rang_eleve_par_matiere_avec_note_nulle(String codeclasse, String codematiere) {
    ...
    public boolean existe_classe_et_eleve_et_matiere(String codematiere, String matricule, String codeclasse) {
        try {
            Seq3rangdeselevesparmatiere c = em.createNamedQuery("Seq3rangdeselevesparmatiere.rang_eleve_par_matiere", Seq3rangdeselevesparmatiere.class).setParameter("codematiere", codematiere).setParameter("matriculeeleve", matricule).setParameter("codeclasse", codeclasse).getSingleResult();
            if (c != null) {
                return true;
            }
            return false;
