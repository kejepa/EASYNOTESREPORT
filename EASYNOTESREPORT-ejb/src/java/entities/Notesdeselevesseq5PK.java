 ...
 */
@Embeddable
public class Notesdeselevesseq5PK implements Serializable {
    ...
    public Notesdeselevesseq5PK() {
    }

    public Notesdeselevesseq5PK(String matriculeeleve, String codematiere) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Notesdeselevesseq5PK)) {
            return false;
        }
        Notesdeselevesseq5PK other = (Notesdeselevesseq5PK) object;
    ...
    public String toString() {
        return "entities.Notesdeselevesseq5PK[ matriculeeleve=" + matriculeeleve + ", codematiere=" + codematiere + " ]";
    }
