 ...
 */
@Embeddable
public class Seq3rangdeselevesparmatierePK implements Serializable {
    ...
    public Seq3rangdeselevesparmatierePK() {
    }

    public Seq3rangdeselevesparmatierePK(String codematiere, String matriculeeleve, String codeclasse) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Seq3rangdeselevesparmatierePK)) {
            return false;
        }
        Seq3rangdeselevesparmatierePK other = (Seq3rangdeselevesparmatierePK) object;
    ...
    public String toString() {
        return "entities.Seq3rangdeselevesparmatierePK[ codematiere=" + codematiere + ", matriculeeleve=" + matriculeeleve + ", codeclasse=" + codeclasse + " ]";
    }
