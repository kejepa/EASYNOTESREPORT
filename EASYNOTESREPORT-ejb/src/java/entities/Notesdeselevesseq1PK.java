 ...
 */
@Embeddable
public class Notesdeselevesseq1PK implements Serializable {
    ...
    public Notesdeselevesseq1PK() {
    }

    public Notesdeselevesseq1PK(String matriculeeleve, String codematiere) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Notesdeselevesseq1PK)) {
            return false;
        }
        Notesdeselevesseq1PK other = (Notesdeselevesseq1PK) object;
    ...
    public String toString() {
        return matriculeeleve + "," + codematiere + " ";
    }
