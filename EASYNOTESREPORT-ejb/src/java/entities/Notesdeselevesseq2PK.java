 ...
 */
@Embeddable
public class Notesdeselevesseq2PK implements Serializable {
    ...
    public Notesdeselevesseq2PK() {
    }

    public Notesdeselevesseq2PK(String matriculeeleve, String codematiere) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Notesdeselevesseq2PK)) {
            return false;
        }
        Notesdeselevesseq2PK other = (Notesdeselevesseq2PK) object;
    ...
    public String toString() {
        return "entities.Notesdeselevesseq2PK[ matriculeeleve=" + matriculeeleve + ", codematiere=" + codematiere + " ]";
    }
