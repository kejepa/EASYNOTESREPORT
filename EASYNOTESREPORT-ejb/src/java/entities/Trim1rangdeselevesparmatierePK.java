 ...
 */
@Embeddable
public class Trim1rangdeselevesparmatierePK implements Serializable {
    ...
    public Trim1rangdeselevesparmatierePK() {
    }

    public Trim1rangdeselevesparmatierePK(String codematiere, String matriculeeleve, String codeclasse) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Trim1rangdeselevesparmatierePK)) {
            return false;
        }
        Trim1rangdeselevesparmatierePK other = (Trim1rangdeselevesparmatierePK) object;
    ...
    public String toString() {
        return "entities.Trim1rangdeselevesparmatierePK[ codematiere=" + codematiere + ", matriculeeleve=" + matriculeeleve + ", codeclasse=" + codeclasse + " ]";
    }
