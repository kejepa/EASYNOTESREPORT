 ...
 */
@Embeddable
public class Seq6rangdeselevesparmatierePK implements Serializable {
    ...
    public Seq6rangdeselevesparmatierePK() {
    }

    public Seq6rangdeselevesparmatierePK(String codematiere, String matriculeeleve, String codeclasse) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Seq6rangdeselevesparmatierePK)) {
            return false;
        }
        Seq6rangdeselevesparmatierePK other = (Seq6rangdeselevesparmatierePK) object;
    ...
    public String toString() {
        return "entities.Seq6rangdeselevesparmatierePK[ codematiere=" + codematiere + ", matriculeeleve=" + matriculeeleve + ", codeclasse=" + codeclasse + " ]";
    }
