 ...
 */
@Embeddable
public class Notesdeselevestrim2PK implements Serializable {
    ...
    public Notesdeselevestrim2PK() {
    }

    public Notesdeselevestrim2PK(String matriculeeleve, String codematiere) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Notesdeselevestrim2PK)) {
            return false;
        }
        Notesdeselevestrim2PK other = (Notesdeselevestrim2PK) object;
    ...
    public String toString() {
        return "entities.Notesdeselevestrim2PK[ matriculeeleve=" + matriculeeleve + ", codematiere=" + codematiere + " ]";
    }
