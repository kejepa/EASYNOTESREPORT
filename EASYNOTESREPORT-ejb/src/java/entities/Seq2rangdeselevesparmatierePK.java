 ...
 */
@Embeddable
public class Seq2rangdeselevesparmatierePK implements Serializable {
    ...
    public Seq2rangdeselevesparmatierePK() {
    }

    public Seq2rangdeselevesparmatierePK(String codematiere, String matriculeeleve, String codeclasse) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Seq2rangdeselevesparmatierePK)) {
            return false;
        }
        Seq2rangdeselevesparmatierePK other = (Seq2rangdeselevesparmatierePK) object;
    ...
    public String toString() {
        return "entities.Seq2rangdeselevesparmatierePK[ codematiere=" + codematiere + ", matriculeeleve=" + matriculeeleve + ", codeclasse=" + codeclasse + " ]";
    }
