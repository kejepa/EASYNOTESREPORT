 ...
 */
@Embeddable
public class Notesdeselevestrim1PK implements Serializable {
    ...
    public Notesdeselevestrim1PK() {
    }

    public Notesdeselevestrim1PK(String matriculeeleve, String codematiere) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Notesdeselevestrim1PK)) {
            return false;
        }
        Notesdeselevestrim1PK other = (Notesdeselevestrim1PK) object;
    ...
    public String toString() {
        return "entities.Notesdeselevestrim1PK[ matriculeeleve=" + matriculeeleve + ", codematiere=" + codematiere + " ]";
    }
