 ...
 */
@Embeddable
public class Seq5rangdeselevesparmatierePK implements Serializable {
    ...
    public Seq5rangdeselevesparmatierePK() {
    }

    public Seq5rangdeselevesparmatierePK(String codematiere, String matriculeeleve, String codeclasse) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Seq5rangdeselevesparmatierePK)) {
            return false;
        }
        Seq5rangdeselevesparmatierePK other = (Seq5rangdeselevesparmatierePK) object;
    ...
    public String toString() {
        return "entities.Seq5rangdeselevesparmatierePK[ codematiere=" + codematiere + ", matriculeeleve=" + matriculeeleve + ", codeclasse=" + codeclasse + " ]";
    }
