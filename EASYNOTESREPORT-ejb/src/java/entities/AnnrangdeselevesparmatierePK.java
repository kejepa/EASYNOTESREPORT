 ...
 */
@Embeddable
public class AnnrangdeselevesparmatierePK implements Serializable {
    ...
    public AnnrangdeselevesparmatierePK() {
    }

    public AnnrangdeselevesparmatierePK(String codematiere, String matriculeeleve, String codeclasse) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof AnnrangdeselevesparmatierePK)) {
            return false;
        }
        AnnrangdeselevesparmatierePK other = (AnnrangdeselevesparmatierePK) object;
    ...
    public String toString() {
        return "entities.AnnrangdeselevesparmatierePK[ codematiere=" + codematiere + ", matriculeeleve=" + matriculeeleve + ", codeclasse=" + codeclasse + " ]";
    }
