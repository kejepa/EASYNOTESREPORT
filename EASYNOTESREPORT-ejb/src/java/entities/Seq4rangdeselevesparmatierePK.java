 ...
 */
@Embeddable
public class Seq4rangdeselevesparmatierePK implements Serializable {
    ...
    public Seq4rangdeselevesparmatierePK() {
    }

    public Seq4rangdeselevesparmatierePK(String codematiere, String matriculeeleve, String codeclasse) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Seq4rangdeselevesparmatierePK)) {
            return false;
        }
        Seq4rangdeselevesparmatierePK other = (Seq4rangdeselevesparmatierePK) object;
    ...
    public String toString() {
        return "entities.Seq4rangdeselevesparmatierePK[ codematiere=" + codematiere + ", matriculeeleve=" + matriculeeleve + ", codeclasse=" + codeclasse + " ]";
    }
