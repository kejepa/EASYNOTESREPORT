 ...
 */
@Embeddable
public class Notesdeselevestrim3PK implements Serializable {
    ...
    public Notesdeselevestrim3PK() {
    }

    public Notesdeselevestrim3PK(String matriculeeleve, String codematiere) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Notesdeselevestrim3PK)) {
            return false;
        }
        Notesdeselevestrim3PK other = (Notesdeselevestrim3PK) object;
    ...
    public String toString() {
        return "entities.Notesdeselevestrim3PK[ matriculeeleve=" + matriculeeleve + ", codematiere=" + codematiere + " ]";
    }
