 ...
 */
@Embeddable
public class Trim3rangdeselevesparmatierePK implements Serializable {
    ...
    public Trim3rangdeselevesparmatierePK() {
    }

    public Trim3rangdeselevesparmatierePK(String codematiere, String matriculeeleve, String codeclasse) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Trim3rangdeselevesparmatierePK)) {
            return false;
        }
        Trim3rangdeselevesparmatierePK other = (Trim3rangdeselevesparmatierePK) object;
    ...
    public String toString() {
        return "entities.Trim3rangdeselevesparmatierePK[ codematiere=" + codematiere + ", matriculeeleve=" + matriculeeleve + ", codeclasse=" + codeclasse + " ]";
    }
