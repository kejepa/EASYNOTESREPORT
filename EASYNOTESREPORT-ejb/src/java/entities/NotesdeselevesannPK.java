 ...
 */
@Embeddable
public class NotesdeselevesannPK implements Serializable {
    ...
    public NotesdeselevesannPK() {
    }

    public NotesdeselevesannPK(String matriculeeleve, String codematiere) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof NotesdeselevesannPK)) {
            return false;
        }
        NotesdeselevesannPK other = (NotesdeselevesannPK) object;
    ...
    public String toString() {
        return "entities.NotesdeselevesannPK[ matriculeeleve=" + matriculeeleve + ", codematiere=" + codematiere + " ]";
    }
