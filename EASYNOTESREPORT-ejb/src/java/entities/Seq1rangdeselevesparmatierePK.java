 ...
 */
@Embeddable
public class Seq1rangdeselevesparmatierePK implements Serializable {
    ...
    public Seq1rangdeselevesparmatierePK() {
    }

    public Seq1rangdeselevesparmatierePK(String codematiere, String matriculeeleve, String codeclasse) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Seq1rangdeselevesparmatierePK)) {
            return false;
        }
        Seq1rangdeselevesparmatierePK other = (Seq1rangdeselevesparmatierePK) object;
    ...
    public String toString() {
        return "entities.Seq1rangdeselevesparmatierePK[ codematiere=" + codematiere + ", matriculeeleve=" + matriculeeleve + ", codeclasse=" + codeclasse + " ]";
    }
