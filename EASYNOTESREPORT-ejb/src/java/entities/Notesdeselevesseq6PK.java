 ...
 */
@Embeddable
public class Notesdeselevesseq6PK implements Serializable {
    ...
    public Notesdeselevesseq6PK() {
    }

    public Notesdeselevesseq6PK(String matriculeeleve, String codematiere) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Notesdeselevesseq6PK)) {
            return false;
        }
        Notesdeselevesseq6PK other = (Notesdeselevesseq6PK) object;
    ...
    public String toString() {
        return "entities.Notesdeselevesseq6PK[ matriculeeleve=" + matriculeeleve + ", codematiere=" + codematiere + " ]";
    }
