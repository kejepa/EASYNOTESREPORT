 ...
 */
@Embeddable
public class Notesdeselevesseq4PK implements Serializable {
    ...
    public Notesdeselevesseq4PK() {
    }

    public Notesdeselevesseq4PK(String matriculeeleve, String codematiere) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Notesdeselevesseq4PK)) {
            return false;
        }
        Notesdeselevesseq4PK other = (Notesdeselevesseq4PK) object;
    ...
    public String toString() {
        return "entities.Notesdeselevesseq4PK[ matriculeeleve=" + matriculeeleve + ", codematiere=" + codematiere + " ]";
    }
